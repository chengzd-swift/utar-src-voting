...
(function () {
  ...
  root.innerHTML = [
    ...
    '.launch{position:fixed;right:22px;bottom:22px;width:56px;height:56px;border-radius:50%;',
      'border:none;cursor:pointer;background:linear-gradient(135deg,#4a8fe0,#2f6ec4);color:#fff;',
      'font-size:24px;box-shadow:0 8px 24px rgba(8,32,68,.42);display:flex;align-items:center;',
      'justify-content:center;transition:transform .18s}',
    '.launch:hover{transform:translateY(-2px)}',
    '.launch:focus-visible{outline:3px solid #9cc6ff;outline-offset:3px}',
    '.launch .dot{position:absolute;top:2px;right:2px;width:13px;height:13px;border-radius:50%;',
      'background:#e9ba55;border:2px solid #fff;display:none}',
    ...
    '.head{background:linear-gradient(135deg,#0e2445,#2f6ec4);color:#fff;padding:14px 16px;',
    ...
    '.hbtn:focus-visible,.close:focus-visible{outline:2px solid #9cc6ff;outline-offset:1px}',
    ...
    '.msg h4{margin:10px 0 5px;font-size:.85rem;font-weight:700;color:#1f4f9a}',
    ...
    '.msg li::marker{color:#2f6ec4}',
    '.msg strong{font-weight:700;color:#10213f}',
    '.msg code{background:#eef3f7;border-radius:4px;padding:1px 5px;font-size:.82em;font-family:ui-monospace,Menlo,monospace}',
    '.msg .reg{color:#2f6ec4;font-weight:700;white-space:nowrap}',
    '.msg a{color:#2f6ec4}',
    ...
    '.me{background:#2f6ec4;color:#fff;border-bottom-right-radius:4px;align-self:flex-end}',
    ...
    '.chip:hover{border-color:#2f6ec4;color:#2f6ec4}',
    ...
    '.foot textarea:focus{outline:none;border-color:#2f6ec4;box-shadow:0 0 0 3px rgba(47,110,196,.16)}',
    '.send{border:none;background:#2f6ec4;color:#fff;border-radius:10px;width:42px;cursor:pointer;',
